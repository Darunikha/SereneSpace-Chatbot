...
export default function ChatWindow() {
  ...
  useEffect(() => {
    localStorage.setItem('serenespace-chat-mode', chatMode);
  }, [chatMode]);
      ...
      <div className="chat-page">
        ...
        <div className="chat-input-area">
          ...
          <div className="chat-toolbar container-limit">
            ...
            <div className="chat-mode-toggle" title="Interaction mode: Listen (reflective & validating) vs Advice (strategies & suggestions)">
              <button
                type="button"
                className={`chat-mode-btn ${chatMode === 'listen' ? 'active' : ''}`}
                onClick={() => setChatMode('listen')}
                title="Empathetic, reflective active listening without unsolicited advice"
              >
              ...
              <button
                type="button"
                className={`chat-mode-btn ${chatMode === 'advice' ? 'active' : ''}`}
                onClick={() => setChatMode('advice')}
                title="Actionable coping strategies, exercises, and wellness advice"
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
